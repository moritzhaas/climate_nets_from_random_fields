...
import climnet.general_utils as gut
import climnet.time_utils as tu
import climnet.spatial_utils as sput
from importlib import reload
from climnet.myutils import gridstep_to_numpoints
...
class BaseDataset:
    ...
    **kwargs
    ...
    def create_grid(self,
        ...
        print(f'Get grid {grid_type}...', flush=True)
        if grid_type == 'gaussian':
            ...
            self.num_points = gridstep_to_numpoints(self.grid_step)
            Grid = grid.FeketeGrid(num_points = self.num_points)
            #dist_equator = grid.degree2distance_equator(self.grid_step)
            # in my version:
            #try:
